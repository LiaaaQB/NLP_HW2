...
from tokenizer_for_3 import BPETokenizer  # TODO: change this to your tokenizer
...
def train_tokenizer(domain_file: str, output_dir: str, vocab_size: int = 10000):
    ...
    # Save the tokenizer
    output_path = os.path.join(output_dir, "tokenizer_3.pkl")
...
if __name__ == "__main__":
    ...
    train_tokenizer('data/domain_1_train.txt', 'tokenizers', 5000)
